const hamburgerSvg = (
  ...
  const birthdaySvg = (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-balloon" viewBox="0 0 16 16">
  ...
  const anniversarySvg = (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-calendar-heart" viewBox="0 0 16 16">
